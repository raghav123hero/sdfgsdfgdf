...
export default class MyDonationScreen extends Component {
      ...
      .then((snapshot) => {
        snapshot.forEach((doc) => {
          ...
          if (requestStatus === "Item Sent") {
            ...
            message =
              this.state.donorName + " has shown interest in Exchaning the Item";
          }
  ...
  renderItem = ({ item, i }) => (
    <ListItem
      ...
      leftElement={<Icon name="exchange" type="font-awesome" color="#696969" />}
        ...
        <View style={{ flex: 1 }}>
          {this.state.allDonations.length === 0 ? (
            <View style={styles.subtitle}>
              <Text style={{ fontSize: 20 }}>List of all Items Exchanged</Text>
            </View>
          ) : (
            <FlatList
